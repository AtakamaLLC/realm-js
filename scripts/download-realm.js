...
>>>>>>> a5e32127 (add additional platform check to download script)
...
function acquire(desired, target) {
  ...
  return fs
    ...
    .then(
      () => openSSLPath && download(`openssl/${dependencies.OPENSSL_VERSION}/Linux/x86_64`, "openssl.tgz", openSSLPath),
    )
